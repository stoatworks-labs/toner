 ...
 *
 * GENERATED by stoatworks-backend/scripts/sync-about.py on 2026-09-24. Do not
...
namespace stoatworks::about
{
    ...
    inline constexpr auto hook = "A photocopier's copy of a copy, for Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/toner/guide/";
